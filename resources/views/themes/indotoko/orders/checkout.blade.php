                    ...
                    <div class="col-lg-7 col-md-6">
                        <form method="POST" action="{{ route('orders.store') }}">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input courier-code" type="radio" name="courier" id="courierPos" value="pos">
                                    <label class="form-check-label" for="courierPos">POS</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input courier-code" type="radio" name="courier" id="courierTiki" value="tiki">
                                    <label class="form-check-label" for="courierTiki">TIKI</label>
                                </div>
                            </div>
                            <div class="mt-3">
