            ...
            <div class="col-md-6">
                <div class="product-detail mt-6 mt-md-0">
                    ...
                    <div class="product-info">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <td>Shipping:</td>
                                    <td><small>Estimasi pengiriman 3 hari.<span class="text-muted">(Free Ongkir)</span></small></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="product-share">
                        <ul>
                            <li><a href="https://www.facebook.com/profile.php?id=61553982374419"><i class="bx bxl-facebook-circle"></i></a></li>
                            <li><a href="https://www.instagram.com/tunas_jaya_persada/"><i class="bx bxl-instagram"></i></a></li>
                            <li><a href="https://wa.me/+6283113771731"><i class="bx bxl-whatsapp"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
